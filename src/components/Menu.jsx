    ...
    <div className='md:flex hidden justify-center'>
      <div className='w-full flex flex-col gap-5'>
        ...
        {/* {console.log(typeof(posts))} */}
        {
          ...
          <button className="p-2 border border-green-400 transition-all duration-300 text-green-500 hover:bg-green-400 hover:text-black hover:border-gray-200" onClick={() => navigate(`/post/${post?._id}`)}>Read More</button>
        </div>
            </div>
          ))
        } 
